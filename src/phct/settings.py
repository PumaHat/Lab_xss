"""
Django settings for phct project.
...
SECRET_KEY = 'django-insecure-vhu6cvmf+bo!yjajpiy6h++c-y^1@&9p&ui-1i(1i!m3s*w+-n'
...
INSTALLED_APPS = [
    'xss.apps.XssConfig',
    'xsssimple.apps.XsssimpleConfig',
